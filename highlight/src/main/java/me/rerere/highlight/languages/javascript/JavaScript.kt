...
internal val JS_BUILT_IN_GLOBALS =
    listOf(
        "setInterval",
        "setTimeout",
        "clearInterval",
...
internal val JS_BUILT_IN_VARIABLES =
    listOf(
        "arguments",
        "this",
        "super",
...
internal fun javascriptKeywords(): Keywords =
    keywords {
        pattern = JS_IDENT_RE
        keyword(JS_KEYWORDS)
        literal(JS_LITERALS)
...
internal fun javascript(): Language =
    Language(
        name = "JavaScript",
